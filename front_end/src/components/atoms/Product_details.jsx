    ...
    <div>
      <div className=" mt-3 ml-3 flex flex-col gap-[60px]">
        <div className="text-center">
          ...
          <div>
            <img src={product.image1} alt={product.name}  className="object-cover rounded-box w-[30%]"/>
            <img src={product.image2} alt={product.name}  className="object-cover rounded-box w-[30%]" />
          </div>
          <div className="mt-2 mb-2 flex space-x-2 items-center">
            <div className="">{product.dimensions}</div>
            <div className="">{product.description}</div>
            <div className="">{product.available}</div>
            <div className="">{product.types}</div>
